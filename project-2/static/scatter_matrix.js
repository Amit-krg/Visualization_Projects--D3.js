function scatterMatrix(file){
  ...
  var comment="Scatter-Matrix plot for : "+f+"  Data-samples" ;
  var para= document.createElement('p');
  para.textContent=comment;
  document.getElementById('matrix').appendChild(para);
  ...
  d3.csv("static/top_"+file+".csv", function(error, data) {
